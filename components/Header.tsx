    ...
    >
      <div className="flex flex-col">
        <span className="font-serif text-2xl md:text-3xl tracking-tighter text-white font-bold italic leading-none">
          Albert <span className="text-[#C5A059]">C.</span>
        </span>
      ...
      <nav className="hidden md:flex space-x-12 text-[10px] uppercase tracking-[0.4em] font-sans font-semibold">
        <a href="#about" className="hover:text-[#C5A059] transition-colors relative group py-2">
          Sobre él
          <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#C5A059] transition-all duration-300 group-hover:w-full"></span>
        </a>
        <a href="#music" className="hover:text-[#C5A059] transition-colors relative group py-2">
          Música
          <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#C5A059] transition-all duration-300 group-hover:w-full"></span>
        </a>
        <a href="#gallery" className="hover:text-[#C5A059] transition-colors relative group py-2">
          Miradas
          <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#C5A059] transition-all duration-300 group-hover:w-full"></span>
        </a>
        <a href="#contact" className="hover:text-[#C5A059] transition-colors relative group py-2">
          Booking
          <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#C5A059] transition-all duration-300 group-hover:w-full"></span>
        </a>
      </nav>
      ...
      <div className="flex items-center gap-6">
        <button className="hidden md:block px-6 py-2 border border-[#C5A059]/40 text-[10px] uppercase tracking-widest text-[#C5A059] hover:bg-[#C5A059] hover:text-black transition-all">
          Directo
        </button>
        <button className="text-[#C5A059] md:hidden">
