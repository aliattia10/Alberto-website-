...
const Music: React.FC = () => {
  return (
    <section id="music" className="py-32 md:py-56 px-6 md:px-12 bg-[#080808] border-y border-[#762C26]/10">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-8 flex justify-end">
              <a 
                ...
                target="_blank"
                className="font-sans text-[10px] font-bold uppercase tracking-[0.3em] text-[#762C26] hover:underline"
              >
                Seguir en Spotify +
              </a>
            </div>
