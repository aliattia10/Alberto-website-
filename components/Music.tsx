...
const Music: React.FC = () => {
  return (
    <section id="music" className="py-32 md:py-56 px-6 md:px-12 bg-[#080808] border-y border-[#C5A059]/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          
          <div className="lg:col-span-4 lg:sticky lg:top-32">
            <span className="font-sans text-[10px] tracking-[0.6em] uppercase text-[#C5A059] mb-4 block">Discografía</span>
            ...
            <div className="flex items-center gap-6">
              <div className="w-12 h-12 rounded-full border border-[#C5A059]/30 flex items-center justify-center animate-pulse">
          ...
          <div className="lg:col-span-8">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#8E6E37] to-[#C5A059] opacity-10 group-hover:opacity-20 transition duration-1000 blur"></div>
            ...
            <div className="mt-8 flex justify-end">
              <a 
                ...
                target="_blank"
                className="font-sans text-[10px] font-bold uppercase tracking-[0.3em] text-[#C5A059] hover:underline"
              >
                Seguir en Spotify +
              </a>
            </div>
