  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto animate-reveal">
        <span className="font-sans text-[10px] md:text-xs font-semibold tracking-[0.6em] uppercase mb-6 block text-[#762C26]">Desde Granada · Flamenco Contemporáneo</span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
          ...
          <a 
            href="#contact"
            className="font-sans text-xs font-bold uppercase tracking-[0.3em] hover:text-[#762C26] transition-colors flex items-center gap-3 group"
          >
            Información 
        ...
        <div className="flex items-center justify-center gap-6">
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-[#762C26] transition-all duration-300 transform hover:scale-110"
            title="Instagram"
          >
          ...
          <a 
            href="https://youtube.com/@albertcarmonaoficial?si=hqVoVFQaTl1qSHPw"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-[#762C26] transition-all duration-300 transform hover:scale-110"
            title="YouTube"
